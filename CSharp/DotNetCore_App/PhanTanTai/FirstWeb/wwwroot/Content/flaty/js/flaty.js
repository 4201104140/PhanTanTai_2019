$(function () {
    ...
    if ($('#nav-horizontal')) {
        var handleNavBarExceedLength = function (isViewPort980) {
            var chatButton = $('#chatButton');
            if (chatButton && chatButton.length !== 0) {
                var shouldHiddenMenuName = isViewPort980 && (chatButton.offset().top > 0);
                if (shouldHiddenMenuName) {
                    $('#nav-horizontal span').addClass('hidden');
                }
                else {
                    $('#nav-horizontal span').removeClass('hidden');
                }
            }
        };
        ...
        var horizontalNavHandler = function () {
            ...
            var isViewPort980 = windowWidth >= 980;

            handleNavBarExceedLength(isViewPort980); // only handle when viewport > 980px
        ...
        $(window).resize(debounce(horizontalNavHandler, 500));
        setTimeout(() => {
    ...
    //autodropdown
    $('ul.nav li.autodropdown').hover(function () {
        var dropdownToggle = jQuery(this).find('.dropdown-toggle');
        dropdownToggle.click();
        dropdownToggle.addClass('hover');
    }, function () {
        var dropdownToggle = jQuery(this).find('.dropdown-toggle');
    ...
    $('#nav-horizontal a.dropdown-toggle').click(function (e) {
        ...
        if ($('#nav-horizontal.nav-xs').size() == 0) {
            $('#nav-horizontal > li > .dropdown-menu').not(submenu).stop(true, true).slideUp(200);
        }
